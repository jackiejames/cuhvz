...
<section class="darkslide">
  ...
  <div class="container center">
    ...
    <div class="row">
      ...
      <h5 class="orange">March 20th - March 24th</h5>
      <p class="description">
      You have successfully registered for the CU Boulder Weeklong HvZ game.
      <br>Be sure to look through the <a href="#player-info">Player Information</a> before the game.
      </p>
      <hr>
    ...
    <div class="row">
      ...
      <div class="offset-by-one four columns">
        ...
        <p><a class="button button-primary" href="doc/sp17-weeklong-waiver.pdf" target="_blank">Safety Waiver</a></p>
        <p><strong class="white">Safety waivers will be collected at orientation.</strong> Remember to bring them to your orientation session!</p>
        <br>
      </div> 
      ...
      <div class="five offset-by-one columns">
        ...
        <p class="description">All participants are required to attend orientation prior to the game. There are three sessions offered, please select one of the time slots below.</p>
        <h5 class="white">Sunday, March 19, 2017</h5>
        <h5 class="white">Benson Room 180</h5>
        ...
        <div class="subheader">Can't make orientation?</div>

        Players who cannot attend the orientation must take <a href="http://goo.gl/forms/rLTV7LhbHuncxt9M2" target="_blank">this quiz</a>. HvZ Mods will be collecting waivers and distributing player wristbands to those players at the <strong class="white">UMC between 9:00am and 5:00pm on Monday, March 20th</strong>. You cannot participate without a wristband.
